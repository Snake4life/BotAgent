...
namespace BotAgent.ServiceReference1 {
    ...
    public interface IServiceClass {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceClass/getCurrentStat", ReplyAction="http://tempuri.org/IServiceClass/getCurrentStatResponse")]
        System.Collections.Generic.Dictionary<string, string> getCurrentStat();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceClass/getCurrentStat", ReplyAction="http://tempuri.org/IServiceClass/getCurrentStatResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<string, string>> getCurrentStatAsync();
    }
    ...
    public partial class ServiceClassClient : System.ServiceModel.ClientBase<BotAgent.ServiceReference1.IServiceClass>, BotAgent.ServiceReference1.IServiceClass {
        ...
        public System.Collections.Generic.Dictionary<string, string> getCurrentStat() {
            return base.Channel.getCurrentStat();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<string, string>> getCurrentStatAsync() {
            return base.Channel.getCurrentStatAsync();
        }
    }
}
